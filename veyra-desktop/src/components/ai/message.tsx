...
export const MessageBranchSelector = ({
    ...
    return (
        <div
            className={cn(
                "inline-flex items-center gap-1 [&>*:not(:first-child)]:rounded-l-md [&>*:not(:last-child)]:rounded-r-md",
                className,
            )}
            {...props}
        />
...
export type MessageResponseProps = Omit<ComponentProps<typeof Markdown>, "content"> & {
    children?: string
}
