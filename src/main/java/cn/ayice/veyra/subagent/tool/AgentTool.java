package cn.ayice.veyra.subagent.tool;
...
/**
 * 启动用户可见子 agent 的工具。它校验子 agent 类型，并把执行交给 SubagentService。
 */
public class AgentTool extends BaseTool {
    ...
    private final SubagentService tasks;

    public AgentTool(SubagentService tasks) {
        this.tasks = tasks;
    }
