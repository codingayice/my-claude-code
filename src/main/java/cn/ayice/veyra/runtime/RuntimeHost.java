...
public class RuntimeHost {
     ...
     */
    public RuntimeHost(SessionService sessions, RunCoordinator runs) {
    ...
    public List<TranscriptItem> transcriptEntries(String sessionId) {
        return sessions.transcript(sessionId).stream()
    ...
    public RunSubmission submitRun(String sessionId, String input, String mode) {
        ...
        sessions.enqueue(sessionId, () -> runs.execute(session, command));
